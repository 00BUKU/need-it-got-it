...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/stores', // UPDATE THIS, where do you want the client to go after you login 
    failureRedirect : '/stores' //  UPDATE THIS, where do you want the client to go if login fails
  }
));
